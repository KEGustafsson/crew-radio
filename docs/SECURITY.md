...
- Codec 0 = PCM16LE frame, 1 = Opus packet, 2 = hello (`ver=2 | transports | ttl | versionCode
  uint16 | nameLen | name`).
- Cost: 32 bytes per packet, about 1.6 kB/s at 50 packets a second.
